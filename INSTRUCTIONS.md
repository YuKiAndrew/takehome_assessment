...
You have been given a working AI chat application built with Next.js, the Vercel AI SDK, and Claude. The chat interface is complete and functional. 
Your task is to **implement two tools** that give the AI assistant new capabilities.
